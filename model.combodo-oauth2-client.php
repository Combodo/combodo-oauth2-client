...
/**
 * Classes and menus for combodo-oauth2-client (version 3.0.0)
 *
...
abstract class Oauth2Client extends cmdbAbstractObject
{
	...
	{
		$aParams = [			'category' => 'bizmodel,searchable',
			'key_type' => 'autoincrement',
			'name_attcode' => ['name'],
			'image_attcode' => '',
			'state_attcode' => '',
			'reconc_keys' => ['name', 'provider'],
  ...
  'no_duplicate' =>
   [
	...
	'is_blocking' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeString("name", ["sql" => 'name', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeText("description", ["sql" => 'description', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("provider", ["sql" => 'provider', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("client_id", ["sql" => 'client_id', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeEncryptedPassword("client_secret", ["sql" => 'client_secret', "is_null_allowed" => false, "on_target_delete" => null, "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeEncryptedPassword("refresh_token", ["sql" => 'refresh_token', "is_null_allowed" => true, "on_target_delete" => null, "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
		MetaModel::Init_AddAttribute(new AttributeDateTime("refresh_token_expiration", ["sql" => 'refresh_token_expiration', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
		MetaModel::Init_AddAttribute(new AttributeEncryptedPassword("access_token", ["sql" => 'access_token', "is_null_allowed" => true, "on_target_delete" => null, "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
		MetaModel::Init_AddAttribute(new AttributeDateTime("access_token_expiration", ["sql" => 'access_token_expiration', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
		MetaModel::Init_AddAttribute(new AttributeString("scope", ["sql" => 'scope', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("authorization_state", ["sql" => 'authorization_state', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
		MetaModel::Init_AddAttribute(new AttributeString("token_type", ["sql" => 'token_type', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false, "tracking_level" => ATTRIBUTE_TRACKING_NONE]));
...
class MicrosoftGraphOauth2Client extends Oauth2Client
{
	public static function Init()
	{
		$aParams = [			'category' => 'bizmodel,searchable',
			...
			'image_attcode' => '',
			'state_attcode' => '',
			'reconc_keys' => ['name', 'tenant', 'provider'],
			'db_table' => 'priv_oauth2_client_microsoftgraph',
			'db_key_field' => 'id',
			'db_finalclass_field' => 'finalclass',];
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("tenant", ["sql" => 'tenant', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
...
class HeadlessOauth2Client extends Oauth2Client
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("username", ["sql" => 'username', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeEncryptedPassword("password", ["sql" => 'password', "is_null_allowed" => false, "on_target_delete" => null, "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("base_url", ["sql" => 'base_url', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("version", ["sql" => 'version', "is_null_allowed" => true, "default_value" => '1.3', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
...
class KeycloakOauth2Client extends Oauth2Client
{
	public static function Init()
	{
		$aParams = [			'category' => 'bizmodel,searchable',
			...
			'image_attcode' => '',
			'state_attcode' => '',
			'reconc_keys' => ['name', 'url', 'realm', 'provider'],
			'db_table' => 'priv_oauth2_client_keycloak',
			'db_key_field' => 'id',
			'db_finalclass_field' => 'finalclass',];
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("url", ["sql" => 'url', "is_null_allowed" => false, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
		MetaModel::Init_AddAttribute(new AttributeString("realm", ["sql" => 'realm', "is_null_allowed" => true, "default_value" => '', "allowed_values" => null, "depends_on" => [], "always_load_in_tables" => false]));
